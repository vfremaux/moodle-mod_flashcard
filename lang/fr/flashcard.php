...
$string['completionallviewed'] = 'Nécessite que toutes les cartes aient été vues une fois ou au moins (cartes) : ';
...
<p>Ce module permet aux apprenants de mémoriser facilement une liste de "choses". Il s\'agit d\'un exercice typique d\'indexation mentale, dans lequel une correspondance entre deux ensembles doit être mémorisée. Nous disons "choses" car à la fois l\'index comme la valeur peuvent être du texte, des images ou du son. </p>
